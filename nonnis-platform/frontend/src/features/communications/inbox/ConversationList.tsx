            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="flex items-center gap-2">
                  <span className={`truncate text-sm ${c.unread ? "font-semibold text-umber" : "font-medium text-slate-700"}`}>{c.contactName ?? c.contactEmail ?? "Unknown"}</span>
                ...
                <span className="mt-0.5 flex items-center gap-1.5">
                  <span className={`truncate text-sm ${c.unread ? "text-slate-700" : "text-slate-500"}`}>{c.subject ?? "(no subject)"}</span>
                ...
                <span className="mt-0.5 flex items-center gap-1.5">
                  <span className="truncate text-xs text-slate-400">{c.preview ?? c.contactEmail}</span>
                </span>
