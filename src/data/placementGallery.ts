...
export const placementGallery: PlacementGalleryCard[] = [
  { title: "Referral arrives", caption: "Care needs, timing, and funding captured clearly.", type: "document", size: "md" },
  { title: "RN review", caption: "Clinical context reviewed before options reach the family.", type: "review", image: `${NEW}/pexels-tima-miroshnichenko-6010874.jpg`, size: "lg" },
  { title: "Match console", caption: "Care-fit options ranked in real time.", type: "ui", size: "md" },
  { title: "Provider shortlist", caption: "Top 3 options become easier to compare.", type: "ranking", size: "md" },
