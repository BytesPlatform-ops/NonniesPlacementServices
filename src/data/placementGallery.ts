...
export const placementGallery: PlacementGalleryCard[] = [
  ...
  { title: "Move-in support", caption: "Follow-up protects the placement after move-in.", type: "care", image: "/assets/nonnis/specialty-care/alzheimers-care-support.jpg", size: "lg" },
