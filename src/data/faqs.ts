...
export const FAMILY_FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "Yes. Nonni's is RN-led. A registered nurse reviews the care picture and the matched options before they reach you. Intelligent matching supports the process; it never replaces clinical judgment.",
  },
  {
    q: "What kinds of care can you help place?",
    a: "Adult Family Homes, Assisted Living, Memory Care, Skilled Nursing, Hospice, and Respite Care across Washington State. If you're unsure which fits, that's what the RN assessment is for.",
  },
  {
    q: "How quickly can a placement happen?",
    a: "It depends on availability and care level. Urgent hospital discharges are handled with priority, while planned moves can take a more measured pace. Timelines are always set with your situation in mind.",
  },
  {
    q: "Do you guarantee a placement?",
    a: "We don't make guarantees about outcomes or availability — no honest placement service can. What we commit to is RN-led guidance and intelligent matching to find strong, real options for your loved one.",
  },
];
