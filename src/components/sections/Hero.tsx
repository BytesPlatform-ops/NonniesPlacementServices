...
import { ShieldCheck, HeartPulse, Users, Star, Stethoscope, ArrowDown } from "lucide-react";
...
const TRUST = [
  { icon: HeartPulse, label: "RN-reviewed on every referral" },
  { icon: ShieldCheck, label: "Behavioral & medical expertise" },
