...
const PROVIDER_SLIDES: Slide[] = [
  ...
  { type: "image", src: "/assets/images/caregiver-resident-room.jpg", caption: "Availability in one clear view", sub: "Care & community, pricing, and funding, live" },
];
...
const WHY = [
  ...
  { icon: Clock, title: "Fill your community faster", description: "Open availability gets surfaced to the right people the moment they're searching." },
];
  ...
  return (
    <>
      ...
      <Section id="why-list" density="normal">
        <SectionHeading eyebrow="Why list with Nonni's" title="Growth built on the right match" description="Vacancies and mismatched inquiries are expensive. A well-matched, RN-reviewed network fixes both." align="center" className="mx-auto" />
      ...
      <Section tone="dark" density="normal">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <SectionHeading eyebrow="Your availability board" tone="dark" title="Real-time care & community, matched to real demand" description="Publish specialties, availability, pricing, and accepted funding. The platform surfaces RN-reviewed, best-fit inquiries — ranked by match score — straight to your queue." />
      ...
      <Section density="normal">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <Reveal className="lg:order-2">
            <SectionHeading eyebrow="Provider portal" title="Everything to manage placements in one place" description="List your community, upload photos, set specialties and pricing, verify your license, and work an inquiry queue that's already matched by an RN." />
          </Reveal>
      ...
      <Section id="list-your-beds" density="normal">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <SectionHeading eyebrow="List Your Community" title="Add your community" description="Tell us about your community and current availability. Listing starts free — we'll verify your license before publishing." />
          <ListBedsForm />
        </div>
      </Section>
