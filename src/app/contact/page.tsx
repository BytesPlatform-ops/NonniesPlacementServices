  ...
  return (
    <>
      <PageHero
        ...
        description="Whether you're a family beginning a search, a hospital coordinating a discharge, or a provider with openings to fill — we're here to help you take the next step. Based in Tacoma, serving all of Washington State."
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <Reveal className="mt-6 flex flex-wrap gap-3">
              ...
              <Button href="/providers#list-your-beds" variant="secondary"><Building2 className="h-4 w-4" aria-hidden /> List Your Community</Button>
            </Reveal>
          </div>
